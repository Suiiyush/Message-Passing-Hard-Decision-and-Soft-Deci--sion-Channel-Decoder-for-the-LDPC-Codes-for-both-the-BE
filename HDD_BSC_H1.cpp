...
int main()
{
	int N=5056,U=3792,i,j,k,count,c1,c2,c3,v1,v2,v3,v4,flag=1,terminate=1,Nsim=1000,Ksim,l,stop;         // N is number of columns and U is number of rows of H - matrix
	...
	srand (time(NULL));
	for(l=0;l<81;l++)                                     // Outer loop for crossover probability p
	{
